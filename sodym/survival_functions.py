...
class FixedSurvival(SurvivalModel):
    ...
    def __init__(
        ...
        dims: DimensionSet,
        time_letter: str = "t",
        lifetime_mean: NamedDimArray = None,
    ):
    ...
    def set_lifetime(self, lifetime_mean: NamedDimArray):
...
class StandardDeviationSurvivalModel(SurvivalModel):
    def __init__(
        ...
        time_letter: str = "t",
        lifetime_mean: NamedDimArray = None,
        lifetime_std: NamedDimArray = None,
    ):
        super().__init__(dims, time_letter)
        self.lifetime_mean = None
    ...
    def set_lifetime(self, lifetime_mean: NamedDimArray, lifetime_std: NamedDimArray):
        self.lifetime_mean = lifetime_mean.cast_to(target_dims=self.dims).values
...
class WeibullSurvival(SurvivalModel):
    ...
    def __init__(
        ...
        dims: DimensionSet,
        time_letter: str = "t",
        lifetime_shape: NamedDimArray = None,
        lifetime_scale: NamedDimArray = None,
    ):
        super().__init__(dims, time_letter)
    ...
    def set_lifetime(self, lifetime_shape: NamedDimArray, lifetime_scale: NamedDimArray):
